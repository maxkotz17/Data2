...
for y in range(2):
	...
	for z in range(len(model_is)):
		...
		LFC=[]
		for i in range(4):
			LFP.append(np.load(folder + seas + '_long_var_T_LFP_' + str(i) + '.npy').transpose())
			LFC.append(np.load(folder + seas + '_long_var_T_LFC_' + str(i) + '.npy'))
		...
		plt.savefig('LFCA_plots/' + ssp + '/' + model + '/LONG_LFCA_panel_' + ssp + '_' + '_' + model + '_' + seas + '.png',bbox_inches='tight')
		plt.close()
		...
		plt.savefig('LFCA_plots/' + ssp + '/' + model + '/LONG_LFCA_panel_' + ssp + '_' + model + '_' + seas + '_cont.png',bbox_inches='tight')
		plt.close()
...
plt.savefig('LFCA_plots/' + ssp + '/' + seas + '_fig3.png',bbox_inches='tight')
plt.close()
