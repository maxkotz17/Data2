...
for y in range(2):
	...
	for z in range(len(model_is)):
		...
		plt.savefig('LFCA_plots/' + ssp + '/' + model + '/LFCA_panel_' + ssp + '_' + model + '.png',bbox_inches='tight')
		plt.close()
		...
		plt.savefig('LFCA_plots/' + ssp + '/' + model + '/LFCA_panel_' + ssp + '_' + model + '_cont.png',bbox_inches='tight')
		plt.close()
...
plt.savefig('LFCA_plots/' + ssp + '/LFC-0_time_series.png')
plt.close()
...
plt.savefig('LFCA_plots/' + ssp + '/LFC-0_spatial_patterns_cont.png',bbox_inches='tight')
plt.close()
...
labels=[str(vmin) + degree_sign + 'C','0' + degree_sign + 'C',str(vmax) + degree_sign + 'C']
cbar.set_ticklabels(labels)
plt.savefig('LFCA_plots/' + ssp + '/LFC-0_dec_diff.png',bbox_inches='tight')
plt.close()
